        ...
        <Container>
          ...
          <Row>
            ...
            <Col className="education m-1">
              ...
              <p>
                Developed a CRM system using Express.js and React.js for
                optimized customer relationship management. Implemented features
                including real-time updates, task management, and dynamic
                reporting. <br />
                <b>Technologies Used:</b> Node.js, Express.js, React.js,
                MongoDB, Swagger UI, JOI, DotEnv, Prettier, and Jira
              </p>
            </Col>
            <Col className="education m-1">
              <h3> ICares24 </h3>
          ...
          <Row>
            <Col className="education m-1">
              ...
              <p>
                ...
                Successfully delivered a robust solution, significantly
                improving overall school operations. <br />
          ...
          <Row>
            <Col className="education m-1">
              ...
              <p>
                ...
                application for movie searching and listing. Utilized the TMDB
                API for data retrieval and incorporated features like search,
                sorting, and showcasing top-rated movies. <br />
